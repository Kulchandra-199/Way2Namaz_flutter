...
class PrayerTimingDetails extends StatefulWidget {
  const PrayerTimingDetails({Key? key}) : super(key: key);

  @override
  _PrayerTimingDetailsState createState() => _PrayerTimingDetailsState();
}

class _PrayerTimingDetailsState extends State<PrayerTimingDetails> {
